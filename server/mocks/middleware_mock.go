...
// MiddlewareMock is a mock implementation of server.Middleware.
//
//	func TestSomethingThatUsesMiddleware(t *testing.T) {
//
//		// make and configure a mocked server.Middleware
...
//		}
//
//		// use mockedMiddleware in code that requires server.Middleware
